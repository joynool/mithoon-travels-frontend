...
const useFirebase = () =>
{
    ...
    useEffect(() =>
    {
        fetch(`https://lit-caverns-48381.herokuapp.com/users/${user.email}`)
            .then(res => res.json())
    ...
    const saveUser = (email, displayName, method) =>
    {
        ...
        fetch('https://lit-caverns-48381.herokuapp.com/users', {
            method: method,
            headers: {
    ...
    return { user, admin, setAdmin, isLoading, setIsLoading, registerUser, loginUser, loginUsingGoogle, logOut, authError, setAuthError };
};
